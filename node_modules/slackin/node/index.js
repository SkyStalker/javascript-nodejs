...
// their code
function slackin(_ref) // jshint ignore:line
{
  ...
  app.get('/iframe/dialog', function (req, res) {
    ...
    if (!name) return res.send(404);
    var dom = (0, _splash2.default)({ coc: coc, path: path, name: name, channels: channels, active: active, total: total, iframe: true });
    res.type('html');
    res.send(dom.toHTML());
  });
