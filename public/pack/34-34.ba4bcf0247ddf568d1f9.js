...
if (b) {
h && (f = b[1].length);
var k = b.index - 1 + f, b = b[0].slice(f), _ = b.length, v = k + _, y = g.slice(0, k + 1), E = g.slice(v + 1), A = [ m, 1 ];
y && A.push(y);
var C = new i(a, p ? n.tokenize(b, p) : b, d);
A.push(C), E && A.push(E), Array.prototype.splice.apply(s, A);
}
}
}
}
...
var a = r(380), c = r(382), l = r(386), u = r(387), p = r(397), h = r(412), f = r(564), d = r(554), m = r(566), g = {
"default": r(427),
zero: r(428),
commonmark: r(429)
...
function u(e, t) {
var r = 0;
return s(w, t) ? w[t] : 35 === t.charCodeAt(0) && x.test(t) && (r = "x" === t[1].toLowerCase() ? parseInt(t.slice(2), 16) : parseInt(t.slice(1), 10), 
c(r)) ? l(r) : e;
}
function p(e) {
...
var y = Object.prototype.hasOwnProperty, E = /\\([!"#$%&'()*+,\-.\/:;<=>?@[\\\]^_`{|}~])/g, A = /&([a-z#][a-z0-9]{1,31});/gi, C = RegExp(E.source + "|" + A.source, "gi"), x = /^#((?:x[a-f0-9]{1,8}|[0-9]{1,8}))/i, w = r(381), S = /[&<>"]/, T = /[&<>"]/g, D = {
"&": "&amp;",
"<": "&lt;",
">": "&gt;",
'"': "&quot;"
...
t.escapeHtml = d, t.arrayReplaceAt = a, t.isSpace = g, t.isWhiteSpace = b, t.isMdAsciiPunct = _, 
t.isPunctChar = k, t.escapeRE = m, t.normalizeReference = v;
},
381: function(e, t, r) {
"use strict";
e.exports = r(257);
...
e.exports = function(e) {
var t, r, o, a, c, l, u, p, h, f, d, m, g, b, k, _, v, y = e.tokens;
if (e.md.options.linkify) for (r = 0, o = y.length; o > r; r++) if ("inline" === y[r].type && e.md.linkify.pretest(y[r].content)) for (a = y[r].children, 
g = 0, t = a.length - 1; t >= 0; t--) if (l = a[t], "link_close" !== l.type) {
if ("html_inline" === l.type && (n(l.content) && g > 0 && g--, i(l.content) && g++), 
!(g > 0) && "text" === l.type && e.md.linkify.test(l.content)) {
for (h = l.content, v = e.md.linkify.match(h), u = [], m = l.level, d = 0, p = 0; p < v.length; p++) b = v[p].url, 
...
c.level = m, u.push(c)), c = new e.Token("link_open", "a", 1), c.attrs = [ [ "href", k ] ], 
c.level = m++, c.markup = "linkify", c.info = "auto", u.push(c), c = new e.Token("text", "", 0), 
c.content = _, c.level = m, u.push(c), c = new e.Token("link_close", "a", -1), c.level = --m, 
...
function i(e, t) {
var r, i, c, p, h, f, d, m, g, b, k, _, v, y, E, A, C, x, w, S, T;
for (w = [], r = 0; r < e.length; r++) {
for (i = e[r], d = e[r].level, C = w.length - 1; C >= 0 && !(w[C].level <= d); C--) ;
if (w.length = C + 1, "text" === i.type) {
c = i.content, h = 0, f = c.length;
e: for (;f > h && (l.lastIndex = h, p = l.exec(c)); ) {
if (E = A = !0, h = p.index + 1, x = "'" === p[0], g = 32, p.index - 1 >= 0) g = c.charCodeAt(p.index - 1); else for (C = r - 1; C >= 0; C--) if ("text" === e[C].type) {
g = e[C].content.charCodeAt(e[C].content.length - 1);
break;
}
if (b = 32, f > h) b = c.charCodeAt(h); else for (C = r + 1; C < e.length; C++) if ("text" === e[C].type) {
b = e[C].content.charCodeAt(0);
break;
}
if (k = a(g) || o(String.fromCharCode(g)), _ = a(b) || o(String.fromCharCode(b)), 
v = s(g), y = s(b), y ? E = !1 : _ && (v || k || (E = !1)), v ? A = !1 : k && (y || _ || (A = !1)), 
34 === b && '"' === p[0] && g >= 48 && 57 >= g && (A = E = !1), E && A && (E = !1, 
A = _), E || A) {
if (A) for (C = w.length - 1; C >= 0 && (m = w[C], !(w[C].level < d)); C--) if (m.single === x && w[C].level === d) {
m = w[C], x ? (S = t.md.options.quotes[2], T = t.md.options.quotes[3]) : (S = t.md.options.quotes[0], 
T = t.md.options.quotes[1]), i.content = n(i.content, p.index, T), e[m.token].content = n(e[m.token].content, m.pos, S), 
h += T.length - 1, m.token === r && (h += S.length - 1), c = i.content, f = c.length, 
w.length = C;
continue e;
}
E ? w.push({
...
single: x,
level: d
}) : A && x && (i.content = n(i.content, p.index, u));
} else x && (i.content = n(i.content, p.index, u));
}
}
}
}
...
var s, o, a, c, l, u, p, h, f, d, m, g, b, k, _, v, y = e.bMarks[t] + e.tShift[t], E = e.eMarks[t];
...
l = [ e.bMarks[t] ], e.bMarks[t] = y; E > y && (m = e.src.charCodeAt(y), n(m)); ) 9 === m ? d += 4 - d % 4 : d++, 
y++;
for (o = y >= E, c = [ e.sCount[t] ], e.sCount[t] = d - f, a = [ e.tShift[t] ], 
e.tShift[t] = y - e.bMarks[t], g = e.md.block.ruler.getRules("blockquote"), s = t + 1; r > s && !(e.sCount[s] < u) && (y = e.bMarks[s] + e.tShift[s], 
E = e.eMarks[s], !(y >= E)); s++) if (62 !== e.src.charCodeAt(y++)) {
if (o) break;
for (v = !1, k = 0, _ = g.length; _ > k; k++) if (g[k](e, s, r, !0)) {
v = !0;
break;
}
if (v) break;
...
l.push(e.bMarks[s]), e.bMarks[s] = y; E > y && (m = e.src.charCodeAt(y), n(m)); ) 9 === m ? d += 4 - d % 4 : d++, 
y++;
...
var c, l, u, p, h, f, d, m, g, b, k, _, v, y, E, A, C, x, w, S, T, D, L, I, R, q, N, O, P = !0;
if ((k = i(e, t)) >= 0) x = !0; else {
if (!((k = n(e, t)) >= 0)) return !1;
x = !1;
}
if (C = e.src.charCodeAt(k - 1), a) return !0;
for (S = e.tokens.length, x ? (b = e.bMarks[t] + e.tShift[t], A = +e.src.substr(b, k - b - 1), 
R = e.push("ordered_list_open", "ol", 1), 1 !== A && (R.attrs = [ [ "start", A ] ])) : R = e.push("bullet_list_open", "ul", 1), 
R.map = D = [ t, 0 ], R.markup = String.fromCharCode(C), c = t, T = !1, I = e.md.block.ruler.getRules("list"); r > c; ) {
...
R.markup = String.fromCharCode(C), R.map = L = [ t, 0 ], f = e.blkIndent, m = e.tight, 
h = e.tShift[t], d = e.sCount[t], g = e.parentType, e.blkIndent = p, e.tight = !0, 
...
e.tShift[t] = h, e.sCount[t] = d, e.tight = m, e.parentType = g, R = e.push("list_item_close", "li", -1), 
R.markup = String.fromCharCode(C), c = t = e.line, L[1] = c, w = e.bMarks[t], c >= r) break;
...
if (C !== e.src.charCodeAt(k - 1)) break;
}
return R = x ? e.push("ordered_list_close", "ol", -1) : e.push("bullet_list_close", "ul", -1), 
R.markup = String.fromCharCode(C), D[1] = c, e.line = c, P && s(e, S), !0;
};
},
404: function(e, t, r) {
"use strict";
...
e.exports = function(e, t, r, a) {
var c, l, u, p, h, f, d, m, g, b, k, _, v, y, E, A = 0, C = e.bMarks[t] + e.tShift[t], x = e.eMarks[t], w = t + 1;
if (91 !== e.src.charCodeAt(C)) return !1;
for (;++C < x; ) if (93 === e.src.charCodeAt(C) && 92 !== e.src.charCodeAt(C - 1)) {
if (C + 1 === x) return !1;
...
for (_ = e.getLines(t, w, e.blkIndent, !1).trim(), x = _.length, C = 1; x > C; C++) {
if (c = _.charCodeAt(C), 91 === c) return !1;
if (93 === c) {
g = C;
break;
}
10 === c ? A++ : 92 === c && (C++, x > C && 10 === _.charCodeAt(C) && A++);
}
if (0 > g || 58 !== _.charCodeAt(g + 1)) return !1;
for (C = g + 2; x > C; C++) if (c = _.charCodeAt(C), 10 === c) A++; else if (!o(c)) break;
if (b = n(_, C, x), !b.ok) return !1;
if (h = e.md.normalizeLink(b.str), !e.md.validateLink(h)) return !1;
for (C = b.pos, A += b.lines, l = C, u = A, k = C; x > C; C++) if (c = _.charCodeAt(C), 
10 === c) A++; else if (!o(c)) break;
for (b = i(_, C, x), x > C && k !== C && b.ok ? (E = b.str, C = b.pos, A += b.lines) : (E = "", 
C = l, A = u); x > C && (c = _.charCodeAt(C), o(c)); ) C++;
if (x > C && 10 !== _.charCodeAt(C) && E) for (E = "", C = l, A = u; x > C && (c = _.charCodeAt(C), 
o(c)); ) C++;
return x > C && 10 !== _.charCodeAt(C) ? !1 : (m = s(_.slice(1, g))) ? a ? !0 : (void 0 === e.env.references && (e.env.references = {}), 
...
409: function(e, t) {
"use strict";
var r = "[a-zA-Z_:][a-zA-Z0-9:._-]*", n = "[^\"'=<>`\\x00-\\x20]+", i = "'[^']*'", s = '"[^"]*"', o = "(?:" + n + "|" + i + "|" + s + ")", a = "(?:\\s+" + r + "(?:\\s*=\\s*" + o + ")?)", c = "<[A-Za-z][A-Za-z0-9\\-]*" + a + "*\\s*\\/?>", l = "<\\/[A-Za-z][A-Za-z0-9\\-]*\\s*>", u = "<!---->|<!--(?:-?[^>-])(?:-?[^-])*-->", p = "<[?].*?[?]>", h = "<![A-Z]+\\s+[^>]*>", f = "<!\\[CDATA\\[[\\s\\S]*?\\]\\]>", d = RegExp("^(?:" + c + "|" + l + "|" + u + "|" + p + "|" + h + "|" + f + ")"), m = RegExp("^(?:" + c + "|" + l + ")");
e.exports.HTML_TAG_RE = d, e.exports.HTML_OPEN_CLOSE_TAG_RE = m;
},
410: function(e, t) {
"use strict";
...
e.exports = function(e, t) {
var r, c, l, u, p, h, f, d, m, g, b = "", k = e.pos, _ = e.posMax, v = e.pos;
...
if (f = s(e.src, h, e.posMax), _ > h && v !== h && f.ok) for (m = f.str, h = f.pos; _ > h && (c = e.src.charCodeAt(h), 
a(c) || 10 === c); h++) ; else m = "";
...
return t || (e.pos = p, e.posMax = u, g = e.push("link_open", "a", 1), g.attrs = r = [ [ "href", b ] ], 
...
var n = r(383), i = r(384), s = r(385), o = r(380).normalizeReference, a = r(380).isSpace;
e.exports = function(e, t) {
var r, c, l, u, p, h, f, d, m, g, b, k, _, v = "", y = e.pos, E = e.posMax;
...
if (f >= E) return !1;
for (_ = f, m = i(e.src, f, e.posMax), m.ok && (v = e.md.normalizeLink(m.str), e.md.validateLink(v) ? f = m.pos : v = ""), 
_ = f; E > f && (c = e.src.charCodeAt(f), a(c) || 10 === c); f++) ;
if (m = s(e.src, f, e.posMax), E > f && _ !== f && m.ok) for (g = m.str, f = m.pos; E > f && (c = e.src.charCodeAt(f), 
a(c) || 10 === c); f++) ; else g = "";
...
b.attrs = r = [ [ "src", v ], [ "alt", "" ] ], b.children = k, b.content = l, g && r.push([ "title", g ])), 
...
var r, n, i, c, l, u, p, h, f, d = e, m = !0, g = !0, b = this.posMax, k = this.src.charCodeAt(e);
...
f = a(n) || o(String.fromCharCode(n)), u = s(r), h = s(n), h ? m = !1 : f && (u || p || (m = !1)), 
u ? g = !1 : p && (h || f || (g = !1)), t ? (c = m, l = g) : (c = m && (!g || p), 
l = g && (!m || f)), {
can_open: c,
can_close: l,
length: i
...
function s(e, r, n, i) {
var s, p, h, f, d, m, g, b, k = !1, _ = e.bMarks[r] + e.tShift[r], v = e.eMarks[r];
...
return g = e.parentType, b = e.lineMax, e.parentType = "container", e.lineMax = p, 
m = e.push("container_" + t + "_open", "div", 1), m.markup = f, m.block = !0, m.info = d, 
m.map = [ r, p ], e.md.block.tokenize(e, r + 1, p), m = e.push("container_" + t + "_close", "div", -1), 
m.markup = e.src.slice(_, s), m.block = !0, e.parentType = g, e.lineMax = b, e.line = p + (k ? 1 : 0), 
!0;
}
r = r || {};
...
function n(e, n, s, o) {
var a, c, l, u, p, h, f, d, m, g, b, k, _, v, y, E, A, C, x, w;
...
f = e.tokens.length, x = !0, w = e.push("dl_open", "dl", 1), w.map = h = [ n, 0 ], 
u = n, l = m;
e: for (;;) {
for (C = !1, w = e.push("dt_open", "dt", 1), w.map = [ u, u ], w = e.push("inline", "", 0), 
w.map = [ u, u ], w.content = e.getLines(u, u + 1, e.blkIndent, !1).trim(), w.children = [], 
w = e.push("dt_close", "dt", -1); ;) {
for (w = e.push("dd_open", "dd", 1), w.map = p = [ m, 0 ], A = c, d = e.eMarks[l], 
g = e.sCount[l] + c - (e.bMarks[l] + e.tShift[l]); d > A && (a = e.src.charCodeAt(A), 
i(a)); ) 9 === a ? g += 4 - g % 4 : g++, A++;
...
e.sCount[l] = g, e.tight = !0, e.parentType = "deflist", e.md.block.tokenize(e, l, s, !0), 
e.tight && !C || (x = !1), C = e.line - l > 1 && e.isEmpty(e.line - 1), e.tShift[l] = y, 
e.sCount[l] = v, e.tight = E, e.parentType = _, e.blkIndent = k, e.ddIndent = b, 
w = e.push("dd_close", "dd", -1), p[1] = m = e.line, m >= s) break e;
...
return w = e.push("dl_close", "dl", -1), h[1] = m, e.line = m, x && r(e, f), !0;
}
...
}(), s = r(500).lang, o = r(378), a = r(570), c = r(571), l = r(572), u = r(574), p = r(578), h = r(580), f = r(581), d = r(431), m = r(577);
e.exports = function() {
function e(t) {
...
var i = /^([a-z0-9.+-]+:)/i, s = /:[0-9]*$/, o = /^(\/\/?(?!\/)[^\?\s]*)(\?[^\s]*)?$/, a = [ "<", ">", '"', "`", " ", "\r", "\n", "	" ], c = [ "{", "}", "|", "\\", "^", "`" ].concat(a), l = [ "'" ].concat(c), u = [ "%", "/", "?", ";", "#" ].concat(l), p = [ "/", "?", "#" ], h = 255, f = /^[+a-z0-9A-Z_-]{0,63}$/, d = /^([+a-z0-9A-Z_-]{0,63})(.*)$/, m = {
javascript: !0,
"javascript:": !0
}, g = {
http: !0,
...
(t || k || l.match(/^\/\/[^@\/]+@[^@\/]+/)) && (c = "//" === l.substr(0, 2), !c || k && m[k] || (l = l.substr(2), 
this.slashes = !0)), !m[k] && (c || k && !g[k])) {
var _ = -1;
...
var x = C[r];
if (x && !x.match(f)) {
for (var w = "", S = 0, T = x.length; T > S; S++) w += x.charCodeAt(S) > 127 ? "x" : x[S];
if (!w.match(f)) {
var D = C.slice(0, r), L = C.slice(r + 1), I = x.match(d);
...
var u = e.re = n({}, r(565)), d = e.__tlds__.slice();
...
565: function(e, t, r) {
"use strict";
var n = t.src_Any = r(560).source, i = t.src_Cc = r(561).source, s = t.src_Z = r(563).source, o = t.src_P = r(553).source, a = t.src_ZPCc = [ s, o, i ].join("|"), c = t.src_ZCc = [ s, i ].join("|"), l = "(?:(?!" + a + ")" + n + ")", u = "(?:(?![0-9]|" + a + ")" + n + ")", p = t.src_ip4 = "(?:(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\\.){3}(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)";
t.src_auth = "(?:(?:(?!" + c + ").)+@)?";
var h = t.src_port = "(?::(?:6(?:[0-4]\\d{3}|5(?:[0-4]\\d{2}|5(?:[0-2]\\d|3[0-5])))|[1-5]?\\d{1,4}))?", f = t.src_host_terminator = "(?=$|" + a + ")(?!-|_|:\\d|\\.-|\\.(?!$|" + a + "))", d = t.src_path = "(?:[/?#](?:(?!" + c + "|[()[\\]{}.,\"'?!\\-]).|\\[(?:(?!" + c + "|\\]).)*\\]|\\((?:(?!" + c + "|[)]).)*\\)|\\{(?:(?!" + c + '|[}]).)*\\}|\\"(?:(?!' + c + '|["]).)+\\"|\\\'(?:(?!' + c + "|[']).)+\\'|\\'(?=" + l + ").|\\.{2,3}[a-zA-Z0-9%/]|\\.(?!" + c + "|[.]).|\\-(?!--(?:[^-]|$))(?:-*)|\\,(?!" + c + ").|\\!(?!" + c + "|[!]).|\\?(?!" + c + "|[?]).)+|\\/)?", m = t.src_email_name = '[\\-;:&=\\+\\$,\\"\\.a-zA-Z0-9_]+', g = t.src_xn = "xn--[a-z0-9\\-]{1,59}", b = t.src_domain_root = "(?:" + g + "|" + u + "{1,63})", k = t.src_domain = "(?:" + g + "|(?:" + l + ")|(?:" + l + "(?:-(?!-)|" + l + "){0,61}" + l + "))", _ = t.src_host = "(?:" + p + "|(?:(?:(?:" + k + ")\\.)*" + b + "))", v = t.tpl_host_fuzzy = "(?:" + p + "|(?:(?:(?:" + k + ")\\.)+(?:%TLDS%)))", y = t.tpl_host_no_ip_fuzzy = "(?:(?:(?:" + k + ")\\.)+(?:%TLDS%))";
t.src_host_strict = _ + f;
var E = t.tpl_host_fuzzy_strict = v + f;
t.src_host_port_strict = _ + h + f;
var A = t.tpl_host_port_fuzzy_strict = v + h + f, C = t.tpl_host_port_no_ip_fuzzy_strict = y + h + f;
t.tpl_host_fuzzy_test = "localhost|\\.\\d{1,3}\\.|(?:\\.(?:%TLDS%)(?:" + a + "|$))", 
t.tpl_email_fuzzy = "(^|>|" + c + ")(" + m + "@" + E + ")", t.tpl_link_fuzzy = "(^|(?![.:/\\-_@])(?:[$+<=>^`|]|" + a + "))((?![$+<=>^`|])" + A + d + ")", 
t.tpl_link_no_ip_fuzzy = "(^|(?![.:/\\-_@])(?:[$+<=>^`|]|" + a + "))((?![$+<=>^`|])" + C + d + ")";
},
566: function(e, t, r) {
var n, i;
(function(e) {
...
var t = "";
return 55296 == (63488 & e) && a("ucs2encode"), e > 65535 && (e -= 65536, t += M(e >>> 10 & 1023 | 55296), 
e = 56320 | 1023 & e), t += M(e);
}).join("");
}
function h(e) {
...
function d(e, t, r) {
var n = 0;
for (e = r ? F(e / D) : e >> 1, e += F(e / t); e > P * S >> 1; n += x) e = F(e / P);
return F(n + (P + 1) * e / (e + T));
}
function m(e) {
var t, r, n, i, s, o, c, l, u, f, m = [], g = e.length, b = 0, k = I, _ = L;
for (r = e.lastIndexOf(R), 0 > r && (r = 0), n = 0; r > n; ++n) e.charCodeAt(n) >= 128 && a("not-basic"), 
m.push(e.charCodeAt(n));
for (i = r > 0 ? r + 1 : 0; g > i; ) {
for (s = b, o = 1, c = x; i >= g && a("invalid-input"), l = h(e.charCodeAt(i++)), 
(l >= x || l > F((C - b) / o)) && a("overflow"), b += l * o, u = _ >= c ? w : c >= _ + S ? S : c - _, 
!(u > l); c += x) f = x - u, o > F(C / f) && a("overflow"), o *= f;
t = m.length + 1, _ = d(b - s, t, 0 == s), F(b / t) > C - k && a("overflow"), k += F(b / t), 
b %= t, m.splice(b++, 0, k);
}
return p(m);
}
function g(e) {
var t, r, n, i, s, o, c, l, p, h, m, g, b, k, _, v = [];
for (e = u(e), g = e.length, t = I, r = 0, s = L, o = 0; g > o; ++o) m = e[o], 128 > m && v.push(M(m));
for (n = i = v.length, i && v.push(R); g > n; ) {
for (c = C, o = 0; g > o; ++o) m = e[o], m >= t && c > m && (c = m);
for (b = n + 1, c - t > F((C - r) / b) && a("overflow"), r += (c - t) * b, t = c, 
o = 0; g > o; ++o) if (m = e[o], t > m && ++r > C && a("overflow"), m == t) {
for (l = r, p = x; h = s >= p ? w : p >= s + S ? S : p - s, !(h > l); p += x) _ = l - h, 
k = x - h, v.push(M(f(h + _ % k, 0))), l = F(_ / k);
v.push(M(f(l, 0))), s = d(r, b, n == i), r = 0, ++n;
}
++r, ++t;
}
return v.join("");
...
function k(e) {
return l(e, function(e) {
return q.test(e) ? "xn--" + g(e) : e;
});
}
var _, v, y = "object" == s(r(568)) && r(568) && r(569), E = "object" == s(t) && t, A = "object" == s(e) && e, C = 2147483647, x = 36, w = 1, S = 26, T = 38, D = 700, L = 72, I = 128, R = "-", q = /[^ -~]/, N = /^xn--/, O = {
overflow: "Overflow: input needs wider integers to process.",
ucs2decode: "UCS-2(decode): illegal sequence",
ucs2encode: "UCS-2(encode): illegal value",
"not-basic": "Illegal input >= 0x80 (not a basic code point)",
"invalid-input": "Invalid input"
}, P = x - w, F = Math.floor, M = String.fromCharCode;
if (_ = {
version: "1.0.0",
ucs2: {
decode: u,
...
toASCII: k,
toUnicode: b
}, E) if (A && A.exports == E) A.exports = _; else for (v in _) _.hasOwnProperty(v) && (E[v] = _[v]); else y ? (n = _, 
i = "function" == typeof n ? n.call(t, r, t, e) : n, !(void 0 !== i && (e.exports = i))) : o.punycode = _;
}(void 0);
}).call(t, r(567)(e));
},
568: function(e, t) {
...
var i = r(573), s = r(575), o = r(576), a = r(501), c = r(577), l = r(500).lang;
...
n.open(), n.write(p(m)), n.close(), "epub" == window.ebookType && setTimeout(function() {
...
s.name = "code", s.value = p(m), i.appendChild(s), t.parentNode.insertBefore(i, t.nextSibling), 
...
var f = e.querySelector("pre"), d = f.querySelector("code"), m = d.textContent;
Prism.highlightElement(d), c(f), i(f, e.getAttribute("data-highlight-block")), s(f, e.getAttribute("data-highlight-inline"));
var g = f.classList.contains("language-javascript"), b = f.classList.contains("language-markup"), k = +e.getAttribute("data-trusted"), _ = +e.getAttribute("data-no-strict");
!_ && g && (m = "'use strict';\n" + m);
var v, y, E = !0;
if (g || b) {
...
var C = e.querySelector('[data-action="edit"]');
...
function n(e, t, r) {
function n() {
_ && clearTimeout(_), m && clearTimeout(m), y = 0, d = m = k = _ = v = void 0;
}
function l(t, r) {
r && clearTimeout(r), m = _ = v = void 0, t && (y = s(), g = e.apply(k, d), _ || m || (d = k = void 0));
}
function u() {
var e = t - (s() - b);
0 >= e || e > t ? l(v, m) : _ = setTimeout(u, e);
}
function p() {
return (_ && v || m && C) && (g = e.apply(k, d)), n(), g;
}
function h() {
l(C, _);
}
function f() {
if (d = arguments, b = s(), k = this, v = C && (_ || !E), A === !1) var r = E && !_; else {
y || m || E || (y = b);
var n = A - (b - y), i = (0 >= n || n > A) && (E || m);
i ? (m && (m = clearTimeout(m)), y = b, g = e.apply(k, d)) : m || (m = setTimeout(h, n));
}
return i && _ ? _ = clearTimeout(_) : _ || t === A || (_ = setTimeout(u, t)), r && (i = !0, 
g = e.apply(k, d)), !i || _ || m || (d = k = void 0), g;
}
var d, m, g, b, k, _, v, y = 0, E = !1, A = !1, C = !0;
if ("function" != typeof e) throw new TypeError(a);
return t = o(t) || 0, i(r) && (E = !!r.leading, A = "maxWait" in r && c(o(r.maxWait) || 0, t), 
C = "trailing" in r ? !!r.trailing : C), f.cancel = n, f.flush = p, f;
}
...
var i = r(592), s = r(589), o = NaN, a = /^\s+|\s+$/g, c = /^[-+]0x[0-9a-f]+$/i, l = /^0b[01]+$/i, u = /^0o[0-7]+$/i, p = parseInt;
e.exports = n;
},
592: function(e, t, r) {
"use strict";
...
//# sourceMappingURL=34-34.ba4bcf0247ddf568d1f9.js.map