...
}(), i = n(155), a = n(148), s = n(150), c = n(157), l = n(159), u = n(160), f = n(161), p = function() {
function t(e) {
...
o.open(a, c, t.sync ? !1 : !0), o.method = a;
var l = i();
...
n.push("");
var a = [];
o.b = e = function(e, r, o) {
this && this.block, this && this.attributes || {};
t.call(this, n, a, e, r, o);
}, o.e = e = function(t) {
...
attributes: {
"data-form": "login",
"class": (e = [ !0 ], r.joinClasses([ [ "login-form", i ? "_modal" : "_inline" ] ].map(r.joinClasses).map(function(t, n) {
...
"use strict";
function r(t) {
t.bem = o, t.t = a, t.thumb = i;
}
var o = n(162)(), i = n(163).thumb, a = n(326);
...
var o = n(327), i = new o("en"), a = n(252).lang, s = {};
...
if (!(y(n) || i(n) || a(n) || 0 === s && c(n))) throw new TypeError("Invalid translation - [String|Object|Array|Number|Boolean] expected.");
this._storage[p(t, e)] = {
translation: n,
locale: t,
raw: !0
...
return n ? this._storage.hasOwnProperty(p(t, e)) : h(this, t, e) ? !0 : !1;
...
0 === wt && o(A)), i !== _ ? (a = f(), a === _ && (a = M), a !== _ ? (vt = e, n = S(r, a), 
...
n !== _ ? (X.test(t.charAt(mt)) ? (r = t.charAt(mt), mt++) : (r = _, 0 === wt && o(Z)), 
r !== _ ? (vt = e, n = U(r), e = n) : (mt = e, e = x)) : (mt = e, e = x), e === _ && (e = mt, 
...
r !== _ ? (vt = e, n = U(r), e = n) : (mt = e, e = x)) : (mt = e, e = x), e === _ && (t.length > mt ? (e = t.charAt(mt), 
mt++) : (e = _, 0 === wt && o(K))), e;
}
function v(t) {
...
//# sourceMappingURL=auth.d45c0423c937da8c9291.js.map