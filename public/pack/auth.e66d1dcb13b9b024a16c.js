...
"use strict";
function r() {
var t = new o(window.authOptions);
...
}(), i = n(638), a = n(631), s = n(633), c = n(765), l = n(157), u = n(159), f = n(160), p = n(641), h = n(630), b = function() {
function t(e) {
r(this, t), this.options = e, e.successRedirect || (e.successRedirect = window.STATUS_CODE < 300 ? window.location.href : "/");
}
return o(t, [ {
key: "render",
value: function() {
this.elem = document.createElement("div"), this.elem.innerHTML = p(l, this.options), 
...
t.preventDefault(), this.elem.innerHTML = p(u, this.options), c.render(this.elem.querySelector(".login-form__recaptcha"));
}), this.delegate('[data-switch="login-form"]', "click", function(t) {
t.preventDefault(), this.elem.innerHTML = p(l, this.options);
}), this.delegate('[data-switch="forgot-form"]', "click", function(t) {
t.preventDefault();
var e = this.elem.querySelector('[type="email"]');
this.elem.innerHTML = p(f, this.options), c.render(this.elem.querySelector(".login-form__recaptcha"));
...
value: function(t) {
if (!t.elements["g-recaptcha-response"].value) return void new h.Error("Подтвердите, пожалуйста, что вы не робот (капча).");
...
if (201 == this.status) return o.elem.innerHTML = p(l, o.options), void o.showFormMessage({
...
r.addEventListener("success", function(t) {
200 == this.status ? (o.elem.innerHTML = p(l, o.options), o.showFormMessage({
html: t.result,
type: "success"
...
a.delegateMixin(b.prototype), t.exports = b;
},
638: function(t, e, n) {
"use strict";
function r(t) {
...
var o = new XMLHttpRequest(), a = t.method || "GET", s = t.body, c = t.url;
o.open(a, c, !t.sync), o.method = a;
var l = i();
l && !t.skipCsrf && o.setRequestHeader("X-XSRF-TOKEN", l), "[object Object]" == {}.toString.call(s) && (o.setRequestHeader("Content-Type", "application/json;charset=UTF-8"), 
s = JSON.stringify(s)), t.noDocumentEvents || (o.addEventListener("loadstart", function(t) {
...
if (-1 == u.indexOf(o.status)) return void n("Ошибка на стороне сервера (код " + o.status + "), попытайтесь позднее.", e);
...
function o(t) {
return (Array.isArray(t) ? t.map(o) : t && "object" === (void 0 === t ? "undefined" : s(t)) ? Object.keys(t).filter(function(e) {
return t[e];
}) : [ t ]).filter(r).join(" ");
}
function i(t) {
...
for (var n = t[0], o = 1; o < t.length; o++) n = u(n, t[o]);
return n;
}
...
var s = i[a], c = t[s];
"class" == s ? (c = o(c)) && r.push(" " + s + '="' + c + '"') : r.push(e.attr(s, c, !1, n));
}
return r.join("");
};
var c = {
...
e.escape = a, e.rethrow = function f(t, e, r, o) {
...
var a = 3, s = o.split("\n"), c = Math.max(r - a, 0), l = Math.min(s.length, r + a), a = s.slice(c, l).map(function(t, e) {
var n = e + c + 1;
return (n == r ? "  > " : "    ") + n + "| " + t;
}).join("\n");
...
var o = n(642)(), i = n(643).thumb, a = n(644).lang, s = n(645);
...
i ? c[0] = r[r.length - 1] + t.element + c[0] : r[r.length] = l;
var f = (i ? r[r.length - 1] + t.element : "") + l;
...
var o = n(646), i = new o("en"), a = n(644).lang, s = {};
...
function l(t, e, n) {
if (null !== t) if (_ && t.forEach === _) t.forEach(e, n); else if (t.length === +t.length) for (var r = 0, o = t.length; o > r; r += 1) e.call(n, t[r], r, t); else for (var i in t) Object.prototype.hasOwnProperty.call(t, i) && e.call(n, t[i], i, t);
}
function u(t) {
var e = 1, n = arguments, r = n.length, o = (t + "").replace(w, function(t) {
if ("%%" === t) return "%";
if (e >= r) return t;
switch (t) {
case "%s":
...
return t && "object" === (void 0 === t ? "undefined" : v(t)) ? void l(f(t), function(t, r) {
e[n + "." + r] = t;
}) : void (e[n] = t);
}), e;
}
...
for (var a, s = t._fallbacks[e] || [ t._defaultLocale ], c = 0, l = s.length; l > c; c++) if (a = p(s[c], n), 
o.hasOwnProperty(a)) return i[r] = a, i[r];
return i[r] = null, null;
}
function b(t, e, n) {
var r = y.indexOf(t, e);
return -1 === r ? u('[pluralizer for "%s" locale not found]', t) : void 0 === n[r] ? u('[plural form %d ("%s") not found in translation]', r, y.forms(t)[r]) : n[r];
}
function d(t) {
return this instanceof d ? (this._defaultLocale = t ? t + "" : F, this._fallbacks = {}, 
this._fallbacks_cache = {}, this._storage = {}, void (this._plurals_cache = {})) : new d(t);
}
function m(t, e, n) {
var r, o, i, a, s, c;
return E.test(e) ? (r = g.parse(e), 1 === r.length && "literal" === r[0].type ? r[0].text : (t._plurals_cache[n] || (t._plurals_cache[n] = new d(n)), 
c = t._plurals_cache[n], o = [], o.push([ 'var str = "", strict, strict_exec, forms, forms_exec, plrl, cache, loc, loc_plzr, anchor;' ]), 
o.push("params = flatten(params);"), l(r, function(t) {
...
return t && "function" == typeof Symbol && t.constructor === Symbol ? "symbol" : typeof t;
}, g = n(648), y = n(649), k = Array.isArray || function(t) {
return "[object Array]" === r(t);
}, _ = Array.prototype.forEach, w = /%[sdj%]/g, F = "en", x = "#@$";
...
if (c(n) && s > 0) return l(n, function(n, r) {
...
if (!(k(n) || i(n) || a(n) || 0 === s && c(n))) throw new TypeError("Invalid translation - [String|Object|Array|Number|Boolean] expected.");
this._storage[p(t, e)] = {
translation: n,
locale: t,
raw: !0
...
var e = this;
return o(t) && (t = JSON.parse(t)), l(t.locales, function(t, n) {
l(t, function(t, r) {
e.addPhrase(n, r, t, 0);
});
...
var c = r(i), l = i < t.length ? t.charAt(i) : null;
return null !== o && a(o), new e(null !== n ? n : s(o, l), o, l, i, c.line, c.column);
}
function a() {
var t, e;
...
function s() {
var e, n, r, i, a;
return e = mt, t.substr(mt, 2) === E ? (n = E, mt += 2) : (n = _, 0 === wt && o(j)), 
n !== _ ? (r = c(), r !== _ ? (t.substr(mt, 2) === O ? (i = O, mt += 2) : (i = _, 
0 === wt && o(A)), i !== _ ? (a = f(), a === _ && (a = S), a !== _ ? (vt = e, n = M(r, a), 
e = n) : (mt = e, e = x)) : (mt = e, e = x)) : (mt = e, e = x)) : (mt = e, e = x), 
e;
}
function c() {
var e, n, r, i;
return e = mt, n = l(), n !== _ ? (124 === t.charCodeAt(mt) ? (r = C, mt++) : (r = _, 
0 === wt && o(L)), r !== _ ? (i = c(), i !== _ ? (vt = e, n = R(n, i), e = n) : (mt = e, 
e = x)) : (mt = e, e = x)) : (mt = e, e = x), e === _ && (e = mt, n = l(), n !== _ && (vt = e, 
n = P(n)), e = n), e;
}
function l() {
var e, n, r, i, a, s;
if (e = mt, 61 === t.charCodeAt(mt) ? (n = T, mt++) : (n = _, 0 === wt && o(q)), 
n !== _) {
if (r = [], H.test(t.charAt(mt)) ? (i = t.charAt(mt), mt++) : (i = _, 0 === wt && o(I)), 
i !== _) for (;i !== _; ) r.push(i), H.test(t.charAt(mt)) ? (i = t.charAt(mt), mt++) : (i = _, 
0 === wt && o(I)); else r = x;
if (r !== _) if (32 === t.charCodeAt(mt) ? (i = N, mt++) : (i = _, 0 === wt && o(z)), 
i === _ && (i = S), i !== _) {
if (a = [], s = u(), s !== _) for (;s !== _; ) a.push(s), s = u(); else a = x;
a !== _ ? (vt = e, n = D(r, a), e = n) : (mt = e, e = x);
...
n !== _ ? (U.test(t.charAt(mt)) ? (r = t.charAt(mt), mt++) : (r = _, 0 === wt && o(X)), 
r !== _ ? (vt = e, n = Z(r), e = n) : (mt = e, e = x)) : (mt = e, e = x), e === _ && (e = mt, 
n = mt, wt++, 124 === t.charCodeAt(mt) ? (r = C, mt++) : (r = _, 0 === wt && o(L)), 
r === _ && (t.substr(mt, 2) === O ? (r = O, mt += 2) : (r = _, 0 === wt && o(A))), 
wt--, r === _ ? n = B : (mt = n, n = x), n !== _ ? (t.length > mt ? (r = t.charAt(mt), 
mt++) : (r = _, 0 === wt && o(K)), r !== _ ? (vt = e, n = W(), e = n) : (mt = e, 
e = x)) : (mt = e, e = x)), e;
}
function f() {
var e, n, r;
return e = mt, 58 === t.charCodeAt(mt) ? (n = V, mt++) : (n = _, 0 === wt && o(Y)), 
n !== _ ? (r = h(), r !== _ ? (vt = e, n = Q(r), e = n) : (mt = e, e = x)) : (mt = e, 
e = x), e;
}
function p() {
var e, n, r, i;
...
r !== _ ? (vt = e, n = Z(r), e = n) : (mt = e, e = x)) : (mt = e, e = x), e === _ && (t.length > mt ? (e = t.charAt(mt), 
mt++) : (e = _, 0 === wt && o(K))), e;
}
function v(t) {
...
if (!r) return -1;
if (!h[r].cFn) return 0;
var o = e + "", i = o.indexOf(".") < 0 ? "" : o.split(".")[1], a = i.length, s = +e, c = +o.split(".")[0], l = 0 === i.length ? 0 : +i.replace(/0+$/, "");
return h[r].cFn(s, c, a, +i, l);
}
function i(t, e) {
var r = n(t);
...
var h = {};
t.exports = i, t.exports.indexOf = o, t.exports.forms = r, t.exports.ordinal = c, 
...
//# sourceMappingURL=auth.e66d1dcb13b9b024a16c.js.map