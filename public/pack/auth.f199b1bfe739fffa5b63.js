...
}(), o = n(379), s = n(372), a = n(374), c = n(157), l = n(159), u = n(160), f = n(382), p = (n(371), 
function() {
function t(e) {
...
e.escape = s, e.rethrow = function f(t, e, r, i) {
...
var i = n(383)(), o = n(384).thumb, s = n(385).lang, a = n(386);
...
t.push("<" + s + r.attrs(r.merge([ n ]), !0) + ">"), e && e(), [ "area", "base", "br", "col", "embed", "hr", "img", "input", "keygen", "link", "menuitem", "meta", "param", "source", "track", "wbr" ].indexOf(s) == -1 && t.push("</" + s + ">");
}
...
var i = n(387), o = new i("en"), s = n(385).lang, a = {};
r.i18n = o, r.requirePhrase = function(t, e) {
a[t] && a[t].indexOf(e) != -1 || (a[t] || (a[t] = []), a[t].push(e), o.addPhrase(s, t, e));
}, t.exports = r;
},
387: function(t, e, n) {
"use strict";
...
function l(t, e, n) {
if (null !== t) if (k && t.forEach === k) t.forEach(e, n); else if (t.length === +t.length) for (var r = 0, i = t.length; r < i; r += 1) e.call(n, t[r], r, t); else for (var o in t) Object.prototype.hasOwnProperty.call(t, o) && e.call(n, t[o], o, t);
}
function u(t) {
...
for (var s, a = t._fallbacks[e] || [ t._defaultLocale ], c = 0, l = a.length; c < l; c++) if (s = p(a[c], n), 
i.hasOwnProperty(s)) return o[r] = s, o[r];
return o[r] = null, null;
}
function b(t, e, n) {
var r = y.indexOf(t, e);
return r === -1 ? u('[pluralizer for "%s" locale not found]', t) : void 0 === n[r] ? u('[plural form %d ("%s") not found in translation]', r, y.forms(t)[r]) : n[r];
}
function d(t) {
...
return t && "function" == typeof Symbol && t.constructor === Symbol ? "symbol" : typeof t;
}, g = n(389), y = n(390), _ = Array.isArray || function(t) {
return "[object Array]" === r(t);
}, k = Array.prototype.forEach, w = /%[sdj%]/g, F = "en", x = "#@$";
...
if (!(_(n) || o(n) || s(n) || 0 === a && c(n))) throw new TypeError("Invalid translation - [String|Object|Array|Number|Boolean] expected.");
this._storage[p(t, e)] = {
translation: n,
locale: t,
raw: !0
...
function i(t) {
mt < _t || (mt > _t && (_t = mt, kt = []), kt.push(t));
}
function o(n, i, o) {
function s(t) {
var e = 1;
...
function s() {
var t, e;
for (t = [], e = d(), e === k && (e = a(), e === k && (e = p())); e !== k; ) t.push(e), 
e = d(), e === k && (e = a(), e === k && (e = p()));
return t;
}
function a() {
...
0 === wt && i(A)), o !== k ? (s = f(), s === k && (s = S), s !== k ? (vt = e, n = M(r, s), 
e = n) : (mt = e, e = x)) : (mt = e, e = x)) : (mt = e, e = x)) : (mt = e, e = x), 
e;
}
function c() {
var e, n, r, o;
return e = mt, n = l(), n !== k ? (124 === t.charCodeAt(mt) ? (r = C, mt++) : (r = k, 
0 === wt && i(L)), r !== k ? (o = c(), o !== k ? (vt = e, n = R(n, o), e = n) : (mt = e, 
e = x)) : (mt = e, e = x)) : (mt = e, e = x), e === k && (e = mt, n = l(), n !== k && (vt = e, 
n = P(n)), e = n), e;
}
function l() {
var e, n, r, o, s, a;
if (e = mt, 61 === t.charCodeAt(mt) ? (n = T, mt++) : (n = k, 0 === wt && i(q)), 
n !== k) {
...
n = mt, wt++, 124 === t.charCodeAt(mt) ? (r = C, mt++) : (r = k, 0 === wt && i(L)), 
...
function h() {
var e, n, r, o, s;
if (e = mt, n = b(), n !== k) if (46 === t.charCodeAt(mt) ? (r = ot, mt++) : (r = k, 
0 === wt && i(st)), r !== k) {
...
var e, n, r;
return e = mt, 92 === t.charCodeAt(mt) ? (n = J, mt++) : (n = k, 0 === wt && i(G)), 
n !== k ? (bt.test(t.charAt(mt)) ? (r = t.charAt(mt), mt++) : (r = k, 0 === wt && i(dt)), 
...
//# sourceMappingURL=auth.f199b1bfe739fffa5b63.js.map