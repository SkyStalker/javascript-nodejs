...
var b = r[f];
b.match(RegExp("^(?!" + t.element + ")" + t.modifier)) ? r[f] = p + b : b.match(RegExp("^" + t.element)) && (n[n.length - 2] ? r[f] = n[n.length - 2] + b : r[f] = n[n.length - 1] + b), 
...
//# sourceMappingURL=authClient-2.497dd532e59467fb98b3.js.map