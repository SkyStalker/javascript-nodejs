...
n !== _) {
if (r = [], H.test(t.charAt(mt)) ? (i = t.charAt(mt), mt++) : (i = _, 0 === wt && o(N)), 
i !== _) for (;i !== _; ) r.push(i), H.test(t.charAt(mt)) ? (i = t.charAt(mt), mt++) : (i = _, 
0 === wt && o(N)); else r = x;
if (r !== _) if (32 === t.charCodeAt(mt) ? (i = z, mt++) : (i = _, 0 === wt && o(D)), 
i === _ && (i = S), i !== _) {
if (a = [], s = u(), s !== _) for (;s !== _; ) a.push(s), s = u(); else a = x;
a !== _ ? (vt = e, n = I(r, a), e = n) : (mt = e, e = x);
...
//# sourceMappingURL=authClient-2.e66d1dcb13b9b024a16c.js.map