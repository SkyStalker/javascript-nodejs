...
}(), i = n(379), a = n(372), s = n(374), l = n(157), c = n(159), u = n(160), f = n(382), p = (n(371), 
function() {
function t(e) {
...
var o = n(383)(), i = n(384).thumb, a = n(385).lang, s = n(386);
...
t.push("<" + a + r.attrs(r.merge([ n ]), !0) + ">"), e && e(), [ "area", "base", "br", "col", "embed", "hr", "img", "input", "keygen", "link", "menuitem", "meta", "param", "source", "track", "wbr" ].indexOf(a) == -1 && t.push("</" + a + ">");
}
...
var o = n(387), i = new o("en"), a = n(385).lang, s = {};
r.i18n = i, r.requirePhrase = function(t, e) {
s[t] && s[t].indexOf(e) != -1 || (s[t] || (s[t] = []), s[t].push(e), i.addPhrase(a, t, e));
}, t.exports = r;
},
387: function(t, e, n) {
"use strict";
...
function c(t, e, n) {
if (null !== t) if (_ && t.forEach === _) t.forEach(e, n); else if (t.length === +t.length) for (var r = 0, o = t.length; r < o; r += 1) e.call(n, t[r], r, t); else for (var i in t) Object.prototype.hasOwnProperty.call(t, i) && e.call(n, t[i], i, t);
}
function u(t) {
...
return t && "object" === (void 0 === t ? "undefined" : v(t)) ? void c(f(t), function(t, r) {
e[n + "." + r] = t;
}) : void (e[n] = t);
}), e;
}
...
for (var a, s = t._fallbacks[e] || [ t._defaultLocale ], l = 0, c = s.length; l < c; l++) if (a = p(s[l], n), 
...
function m(t, e, n) {
var r, o, i, a, s, l;
return j.test(e) ? (r = g.parse(e), 1 === r.length && "literal" === r[0].type ? r[0].text : (t._plurals_cache[n] || (t._plurals_cache[n] = new d(n)), 
...
return t && "function" == typeof Symbol && t.constructor === Symbol ? "symbol" : typeof t;
}, g = n(389), y = n(390), k = Array.isArray || function(t) {
...
if (!(k(n) || i(n) || a(n) || 0 === s && l(n))) throw new TypeError("Invalid translation - [String|Object|Array|Number|Boolean] expected.");
this._storage[p(t, e)] = {
translation: n,
locale: t,
raw: !0
...
function o(t) {
mt < kt || (mt > kt && (kt = mt, _t = []), _t.push(t));
}
function i(n, o, i) {
function a(t) {
var e = 1;
...
0 === wt && o(E)), i !== _ ? (a = f(), a === _ && (a = S), a !== _ ? (vt = e, n = M(r, a), 
e = n) : (mt = e, e = x)) : (mt = e, e = x)) : (mt = e, e = x)) : (mt = e, e = x), 
e;
}
function l() {
var e, n, r, i;
return e = mt, n = c(), n !== _ ? (124 === t.charCodeAt(mt) ? (r = P, mt++) : (r = _, 
...
0 === wt && o(I)); else r = x;
if (r !== _) if (32 === t.charCodeAt(mt) ? (i = D, mt++) : (i = _, 0 === wt && o(N)), 
i === _ && (i = S), i !== _) {
...
n = mt, wt++, 124 === t.charCodeAt(mt) ? (r = P, mt++) : (r = _, 0 === wt && o(C)), 
...
//# sourceMappingURL=authClient-2.f199b1bfe739fffa5b63.js.map