...
return n.length ? t.elements.content.value ? void 0 : (new a.Error("Вы забыли написать текст отзыва."), 
...
t.querySelector(".course-feedback__userpic-img").src = s(n.link, 86, 86), e.querySelector("i").style.backgroundImage = "url('" + s(n.link, 64, 64) + "')", 
...
var s = n(384).thumb, o = n(393), a = n(371);
r();
},
116: function(t, e) {},
124: function(t, e, n) {
...
}(), c = i.BlobBuilder || i.WebKitBlobBuilder || i.MozBlobBuilder || i.MSBlobBuilder, l = /^data:((.*?)(;charset=.*?)?)(;base64)?,/, u = (o || c) && i.atob && i.ArrayBuffer && i.Uint8Array && function(t) {
var e, n, r, i, s, u, h, f, d;
if (e = t.match(l), !e) throw Error("invalid data URI");
for (n = e[2] ? e[1] : "text/plain" + (e[3] || ";charset=US-ASCII"), r = !!e[4], 
i = t.slice(e[0].length), s = r ? atob(i) : decodeURIComponent(i), u = new ArrayBuffer(s.length), 
h = new Uint8Array(u), f = 0; f < s.length; f += 1) h[f] = s.charCodeAt(f);
return o ? new Blob([ a ? h : u ], {
type: n
}) : (d = new c(), d.append(u), d.getBlob(n));
};
i.HTMLCanvasElement && !s.toBlob && (s.mozGetAsFile ? s.toBlob = function(t, e, n) {
t(n && s.toDataURL && u ? u(this.toDataURL(e, n)) : this.mozGetAsFile("blob", e));
} : s.toDataURL && u && (s.toBlob = function(t, e, n) {
...
if (u.indexOf(i.status) == -1) return void n("Ошибка на стороне сервера (код " + i.status + "), попытайтесь позднее.", e);
...
var o = 3, a = i.split("\n"), c = Math.max(r - o, 0), l = Math.min(a.length, r + o), o = a.slice(c, l).map(function(t, e) {
var n = e + c + 1;
return (n == r ? "  > " : "    ") + n + "| " + t;
}).join("\n");
...
var i = n(383)(), s = n(384).thumb, o = n(385).lang, a = n(386);
...
s ? c[0] = r[r.length - 1] + t.element + c[0] : r[r.length] = l;
var h = (s ? r[r.length - 1] + t.element : "") + l;
...
var i = n(387), s = new i("en"), o = n(385).lang, a = {};
...
function l(t, e, n) {
if (null !== t) if (w && t.forEach === w) t.forEach(e, n); else if (t.length === +t.length) for (var r = 0, i = t.length; r < i; r += 1) e.call(n, t[r], r, t); else for (var s in t) Object.prototype.hasOwnProperty.call(t, s) && e.call(n, t[s], s, t);
}
function u(t) {
...
return t && "object" === (void 0 === t ? "undefined" : y(t)) ? void l(h(t), function(t, r) {
e[n + "." + r] = t;
}) : void (e[n] = t);
}), e;
}
...
for (var o, a = t._fallbacks[e] || [ t._defaultLocale ], c = 0, l = a.length; c < l; c++) if (o = f(a[c], n), 
i.hasOwnProperty(o)) return s[r] = o, s[r];
return s[r] = null, null;
}
function p(t, e, n) {
var r = b.indexOf(t, e);
return r === -1 ? u('[pluralizer for "%s" locale not found]', t) : void 0 === n[r] ? u('[plural form %d ("%s") not found in translation]', r, b.forms(t)[r]) : n[r];
}
function v(t) {
...
function m(t, e, n) {
var r, i, s, o, a, c;
return z.test(e) ? (r = g.parse(e), 1 === r.length && "literal" === r[0].type ? r[0].text : (t._plurals_cache[n] || (t._plurals_cache[n] = new v(n)), 
...
if ("variable" === t.type) return s = t.anchor, void i.push(u('str += ("undefined" === typeof (params[%j])) ? "[missed variable: %s]" : params[%j];', s, s, s));
if ("plural" !== t.type) throw Error("Unknown node type");
s = t.anchor, o = {}, l(t.strict, function(e, r) {
var i = g.parse(e);
...
i.push(u("anchor = params[%j];", s)), i.push(u("cache = this._plurals_cache[loc];")), 
i.push(u("strict = %j;", t.strict)), i.push(u("strict_exec = %j;", o)), i.push(u("forms = %j;", t.forms)), 
i.push(u("forms_exec = %j;", a)), i.push("if (+(anchor) != anchor) {"), i.push(u('  str += "[invalid plurals amount: %s(" + anchor + ")]";', s)), 
...
return t && "function" == typeof Symbol && t.constructor === Symbol ? "symbol" : typeof t;
}, g = n(389), b = n(390), x = Array.isArray || function(t) {
...
function i(t) {
mt < xt || (mt > xt && (xt = mt, wt = []), wt.push(t));
}
function s(n, i, s) {
function o(t) {
var e = 1;
...
var c = r(s), l = s < t.length ? t.charAt(s) : null;
return null !== i && o(i), new e(null !== n ? n : a(i, l), i, l, s, c.line, c.column);
}
function o() {
var t, e;
...
function a() {
var e, n, r, s, o;
return e = mt, t.substr(mt, 2) === z ? (n = z, mt += 2) : (n = w, 0 === St && i(F)), 
n !== w ? (r = c(), r !== w ? (t.substr(mt, 2) === _ ? (s = _, mt += 2) : (s = w, 
0 === St && i(E)), s !== w ? (o = h(), o === w && (o = A), o !== w ? (yt = e, n = j(r, o), 
e = n) : (mt = e, e = k)) : (mt = e, e = k)) : (mt = e, e = k)) : (mt = e, e = k), 
e;
}
function c() {
var e, n, r, s;
return e = mt, n = l(), n !== w ? (124 === t.charCodeAt(mt) ? (r = I, mt++) : (r = w, 
0 === St && i(R)), r !== w ? (s = c(), s !== w ? (yt = e, n = O(n, s), e = n) : (mt = e, 
e = k)) : (mt = e, e = k)) : (mt = e, e = k), e === w && (e = mt, n = l(), n !== w && (yt = e, 
n = M(n)), e = n), e;
}
function l() {
var e, n, r, s, o, a;
if (e = mt, 61 === t.charCodeAt(mt) ? (n = L, mt++) : (n = w, 0 === St && i(q)), 
n !== w) {
if (r = [], D.test(t.charAt(mt)) ? (s = t.charAt(mt), mt++) : (s = w, 0 === St && i(B)), 
s !== w) for (;s !== w; ) r.push(s), D.test(t.charAt(mt)) ? (s = t.charAt(mt), mt++) : (s = w, 
0 === St && i(B)); else r = k;
if (r !== w) if (32 === t.charCodeAt(mt) ? (s = P, mt++) : (s = w, 0 === St && i(T)), 
s === w && (s = A), s !== w) {
if (o = [], a = u(), a !== w) for (;a !== w; ) o.push(a), a = u(); else o = k;
o !== w ? (yt = e, n = U(r, o), e = n) : (mt = e, e = k);
} else mt = e, e = k; else mt = e, e = k;
} else mt = e, e = k;
if (e === w) {
if (e = mt, n = [], r = u(), r !== w) for (;r !== w; ) n.push(r), r = u(); else n = k;
n !== w && (yt = e, n = N()), e = n;
}
return e;
}
...
r === w && (t.substr(mt, 2) === _ ? (r = _, mt += 2) : (r = w, 0 === St && i(E))), 
...
function h() {
var e, n, r;
return e = mt, 58 === t.charCodeAt(mt) ? (n = V, mt++) : (n = w, 0 === St && i(Y)), 
n !== w ? (r = d(), r !== w ? (yt = e, n = Q(r), e = n) : (mt = e, e = k)) : (mt = e, 
e = k), e;
}
function f() {
var e, n, r, s;
...
function p() {
var e, n, r, s;
if (e = mt, ct.test(t.charAt(mt)) ? (n = t.charAt(mt), mt++) : (n = w, 0 === St && i(lt)), 
n !== w) {
for (r = [], ut.test(t.charAt(mt)) ? (s = t.charAt(mt), mt++) : (s = w, 0 === St && i(ht)); s !== w; ) r.push(s), 
ut.test(t.charAt(mt)) ? (s = t.charAt(mt), mt++) : (s = w, 0 === St && i(ht));
...
if (!r) return -1;
if (!d[r].cFn) return 0;
var i = e + "", s = i.indexOf(".") < 0 ? "" : i.split(".")[1], o = s.length, a = +e, c = +i.split(".")[0], l = 0 === s.length ? 0 : +s.replace(/0+$/, "");
return d[r].cFn(a, c, o, +s, l);
}
function s(t, e) {
var r = n(t);
...
var n = t.elem, r = t.onSuccess, c = t.onLoadStart, l = t.onLoadEnd, u = n.querySelector("a"), h = n.querySelector("i");
...
var i = n(394), s = n(371), o = n(379), a = n(374);
t.exports = r;
},
394: function(t, e, n) {
"use strict";
...
395: function(t, e, n) {
"use strict";
var r = n(377), i = n(169), s = n(382), o = n(396);
...
c.focus();
for (var l = a.elem.querySelectorAll(".photo-cut__selection-canvas"), u = 0; u < l.length; u++) l[u].width = l[u].offsetWidth, 
l[u].height = l[u].offsetHeight;
var h = new o(c, {
maxImageSize: 300
});
h.setImage(t), c.addEventListener("selection", function(t) {
for (var e = h.getCanvasSelection(), n = 0; n < l.length; n++) {
var r = l[n];
...
e < 0 && (e = 0), n < 0 && (n = 0), this.setSelection({
x: e,
y: n,
...
//# sourceMappingURL=coursesFeedbackEdit.f199b1bfe739fffa5b63.js.map