...
}(), c = n.BlobBuilder || n.WebKitBlobBuilder || n.MozBlobBuilder || n.MSBlobBuilder, h = /^data:((.*?)(;charset=.*?)?)(;base64)?,/, l = (r || c) && n.atob && n.ArrayBuffer && n.Uint8Array && function(t) {
var e, i, s, n, o, l, u, d, f;
if (e = t.match(h), !e) throw Error("invalid data URI");
for (i = e[2] ? e[1] : "text/plain" + (e[3] || ";charset=US-ASCII"), s = !!e[4], 
n = t.slice(e[0].length), o = s ? atob(n) : decodeURIComponent(n), l = new ArrayBuffer(o.length), 
u = new Uint8Array(l), d = 0; d < o.length; d += 1) u[d] = o.charCodeAt(d);
return r ? new Blob([ a ? u : l ], {
type: i
}) : (f = new c(), f.append(l), f.getBlob(i));
};
...
//# sourceMappingURL=coursesParticipantDetails.10a4b79a3818d8a82138.js.map