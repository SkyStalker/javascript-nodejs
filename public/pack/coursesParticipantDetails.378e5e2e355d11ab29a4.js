...
t.querySelector("i").style.backgroundImage = "url('" + o(e.link, 64, 64) + "')", 
...
}(), c = n.BlobBuilder || n.WebKitBlobBuilder || n.MozBlobBuilder || n.MSBlobBuilder, h = (r || c) && n.atob && n.ArrayBuffer && n.Uint8Array && function(t) {
var e, i, s, n, o, h;
...
type: o
}) : (h = new c(), h.append(i), h.getBlob(o));
};
n.HTMLCanvasElement && !o.toBlob && (o.mozGetAsFile ? o.toBlob = function(t, e, i) {
t(i && o.toDataURL && h ? h(this.toDataURL(e, i)) : this.mozGetAsFile("blob", e));
} : o.toDataURL && h && (o.toBlob = function(t, e, i) {
t(h(this.toDataURL(e, i)));
})), s = function() {
return h;
...
var h = o();
h && !t.skipCsrf && n.setRequestHeader("X-XSRF-TOKEN", h), "[object Object]" == {}.toString.call(a) && (n.setRequestHeader("Content-Type", "application/json;charset=UTF-8"), 
...
if (-1 == l.indexOf(n.status)) return void i("Ошибка на стороне сервера (код " + n.status + "), попытайтесь позднее.", e);
...
e.merge = function h(t, e) {
if (1 === arguments.length) {
for (var i = t[0], n = 1; n < t.length; n++) i = h(i, t[n]);
return i;
}
...
e.escape = r, e.rethrow = function l(t, e, s, n) {
...
var r = 3, a = n.split("\n"), c = Math.max(s - r, 0), h = Math.min(a.length, s + r), r = a.slice(c, h).map(function(t, e) {
var i = e + c + 1;
return (i == s ? "  > " : "    ") + i + "| " + t;
}).join("\n");
...
var h;
try {
h = c[0].match(RegExp("^(((?!" + t.element + "|" + t.modifier + ").)+)"))[1];
} catch (l) {
throw Error("Incorrect bem class: " + c[0]);
}
o ? c[0] = s[s.length - 1] + t.element + c[0] : s[s.length] = h;
var u = (o ? s[s.length - 1] + t.element : "") + h;
-1 === c.indexOf(u) && (c[c.length] = u);
for (var f = 0; f < c.length; f++) {
var d = c[f];
d.match(RegExp("^(?!" + t.element + ")" + t.modifier)) ? c[f] = u + d : d.match(RegExp("^" + t.element)) && (s[s.length - 2] ? c[f] = s[s.length - 2] + d : c[f] = s[s.length - 1] + d), 
c[f].match(RegExp("^" + u + "($|(?=" + t.element + "|" + t.modifier + "))")) && (c[f] = t.prefix + c[f]);
}
a.class = c.sort().join(" ");
}
e(i, r, a, s, n), o || s.pop();
...
var i = t.elem, s = t.onSuccess, c = t.onLoadStart, h = t.onLoadEnd, l = i.querySelector("a"), u = i.querySelector("i");
...
var n = i(166), o = i(147), r = i(155), a = i(150);
t.exports = s;
},
166: function(t, e, i) {
"use strict";
...
var o = new Image();
o.onload = function() {
o.height < e || o.width < e ? new s.Error("Изображение должно иметь размер " + e + "x" + e + " или больше") : n(o, function(t) {
i(t);
});
}, o.onerror = function() {
...
168: function(t, e, i) {
"use strict";
var s = i(153), n = i(169), o = i(161), r = i(350);
i(124), t.exports = function(t, e) {
function i() {
var i = u.getCanvasSelection();
if (i) {
var s = document.createElement("canvas");
s.width = i.size, s.height = i.size;
var n = s.getContext("2d");
n.drawImage(i.source, i.x, i.y, i.size, i.size, 0, 0, i.size, i.size), n.globalCompositeOperation = "destination-over", 
n.fillStyle = "rgb(255,255,255)", n.fillRect(0, 0, s.width, s.height), a.remove(), 
s.toBlob(function(t) {
e(t);
...
c.focus();
for (var h = a.elem.querySelectorAll(".photo-cut__selection-canvas"), l = 0; l < h.length; l++) h[l].width = h[l].offsetWidth, 
h[l].height = h[l].offsetHeight;
var u = new r(c, {
maxImageSize: 300
});
u.setImage(t), c.addEventListener("selection", function(t) {
for (var e = u.getCanvasSelection(), i = 0; i < h.length; i++) {
var s = h[i];
...
this.selection = new o(t)) : this.selection = null, this.render(), this.canvas.dispatchEvent(new CustomEvent("selection", {
bubbles: !0
}));
}
}, {
...
//# sourceMappingURL=coursesParticipantDetails.378e5e2e355d11ab29a4.js.map