...
var a = new XMLHttpRequest(), i = e.method || "GET", s = e.body, c = e.url;
a.open(i, c, !e.sync), a.method = i;
var u = o();
u && !e.skipCsrf && a.setRequestHeader("X-XSRF-TOKEN", u), "[object Object]" == {}.toString.call(s) && (a.setRequestHeader("Content-Type", "application/json;charset=UTF-8"), 
...
}(), o = n(147), i = n(155), s = n(150), c = (n(153), function() {
function e(t, n) {
...
}(), o = (n(155), n(147)), i = n(148), s = n(176).FormPayment, c = (n(150), n(153), 
function() {
function e(t) {
var n = this;
r(this, e), this.elem = t.elem, this.product = "ebook", this.elem.addEventListener("submit", function(e) {
return n.onSubmit(e);
...
//# sourceMappingURL=ebook.907dd6cbd22f1e47ddc8.js.map