...
this.delegate("[data-mdeditor-resize]", "mousedown", this.onResizeMouseDown), this.textArea.addEventListener("input", this.renderPreviewThrottled), 
...
this.textArea.selectionEnd = a.length + e.length + r.length), this.renderPreviewTrottled();
}
}, {
key: "render",
value: function(e) {
...
//# sourceMappingURL=mdeditor.d45c0423c937da8c9291.js.map