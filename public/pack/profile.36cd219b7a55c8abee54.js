...
}(), s = r(644).lang, o = r(378), a = r(712), c = r(713), u = r(714), l = r(716), h = r(720), f = r(722), d = r(723), p = r(770), m = r(431), g = r(719);
t.exports = function() {
function t(e) {
n(this, t), e = e || {}, this.options = e, this.env = e.env || {}, this.md = new o(Object.assign({
typographer: !0,
...
function n(t) {
var e, r;
for (e = 0; e < t.length; e++) r = t[e], "text" === r.type && (r.content = r.content.replace("[cut]", ""));
}
t.exports = function(t, e) {
t.core.ruler.before("replacements", "remove_cut", r);
};
}
});
//# sourceMappingURL=profile.36cd219b7a55c8abee54.js.map