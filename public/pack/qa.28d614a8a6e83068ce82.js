...
S && N.push(S);
var v = new r(o, d ? a.tokenize(E, d) : E, g);
N.push(v), I && N.push(I), Array.prototype.splice.apply(i, N);
}
}
}
}
...
Prism.highlightElement(g), l(h), r(h, e.getAttribute("data-highlight-block")), i(h, e.getAttribute("data-highlight-inline"));
...
//# sourceMappingURL=qa.28d614a8a6e83068ce82.js.map