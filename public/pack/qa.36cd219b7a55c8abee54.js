...
"use strict";
function a() {
alert("Welcome to Q&A"), r.init();
}
n(775);
var r = (n(633), n(638), n(724));
n(630);
a();
},
87: function(e, t) {
...
var u = l[c], d = u.inside, p = !!u.lookbehind, g = !!u.greedy, h = 0, m = u.alias;
u = u.pattern || u;
...
var b = u.exec(E), T = 1;
if (!b && g && f != i.length - 1) {
var A = i[f + 1].matchedStr || i[f + 1], S = E + A;
if (f < i.length - 2 && (S += i[f + 2].matchedStr || i[f + 2]), u.lastIndex = 0, 
b = u.exec(S), !b) continue;
var I = b.index + (p ? b[1].length : 0);
if (I >= E.length) continue;
var y = b.index + b[0].length, N = E.length + A.length;
if (T = 3, N >= y) {
if (i[f + 1].greedy) continue;
T = 2, S = S.slice(0, N);
}
E = S;
}
if (b) {
p && (h = b[1].length);
var I = b.index + h, b = b[0].slice(h), y = I + b.length, v = E.slice(0, I), w = E.slice(y), R = [ f, T ];
v && R.push(v);
var O = new r(o, d ? a.tokenize(b, d) : b, m, b, g);
R.push(O), w && R.push(w), Array.prototype.splice.apply(i, R);
}
}
}
}
...
return i && (a.filename = i.src, document.addEventListener && !i.hasAttribute("data-manual") && ("loading" !== document.readyState ? requestAnimationFrame(a.highlightAll, 0) : document.addEventListener("DOMContentLoaded", a.highlightAll))), 
n.Prism;
}();
...
function n() {
var t;
if (I && e.hasAttribute("data-refresh") && (I.remove(), I = null), I || (I = e.querySelector(".code-result")), 
I) t = I.querySelector("iframe"); else {
if (I = document.createElement("div"), I.className = "code-result code-example__result", 
...
}, 2e3), e.hasAttribute("data-demo-height") || s.iframe(t), y && e.hasAttribute("data-autorun") || o(I) || I.scrollIntoView(!1);
} else {
...
i.name = "code", i.value = d(m), r.appendChild(i), t.parentNode.insertBefore(r, t.nextSibling), 
r.submit(), r.remove(), y && e.hasAttribute("data-autorun") || (t.onload = function() {
e.hasAttribute("data-demo-height") || s.iframe(t), o(I) || I.scrollIntoView(!1);
});
}
}
function a(e) {
...
S || (S = document.createElement("iframe"), S.className = "js-frame", S.style.width = 0, 
S.style.height = 0, S.style.border = "none", S.name = "js-global-frame", document.body.appendChild(S));
...
S.parentNode.insertBefore(n, S.nextSibling), n.submit(), n.remove();
} else if (b) {
...
function d(e) {
var t = e.toLowerCase(), n = t.match("<body>"), a = t.match("</body>"), r = t.match("<html>"), i = t.match("</html>"), s = t.match(/^\s*<!doctype/);
if (s) return e;
var o = e;
...
var g = e.querySelector("pre"), h = g.querySelector("code"), m = h.textContent;
Prism.highlightElement(h), l(g), r(g, e.getAttribute("data-highlight-block")), i(g, e.getAttribute("data-highlight-inline"));
var f = g.classList.contains("language-javascript"), E = g.classList.contains("language-markup"), b = +e.getAttribute("data-trusted"), T = +e.getAttribute("data-no-strict");
!T && f && (m = "'use strict';\n" + m);
var A, S, I, y = !0;
if (f || E) {
...
//# sourceMappingURL=qa.36cd219b7a55c8abee54.js.map