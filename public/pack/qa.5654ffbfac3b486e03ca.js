...
if (E) {
p && (h = E[1].length);
var T = E.index - 1 + h, E = E[0].slice(h), b = E.length, A = T + b, S = f.slice(0, T + 1), N = f.slice(A + 1), I = [ m, 1 ];
S && I.push(S);
var R = new r(o, d ? t.tokenize(E, d) : E, g);
I.push(R), N && I.push(N), Array.prototype.splice.apply(i, I);
}
}
}
}
...
}, 2e3), e.hasAttribute("data-demo-height") || s.iframe(t), N && e.hasAttribute("data-autorun") || o(S) || S.scrollIntoView(!1);
} else {
...
r.submit(), r.remove(), N && e.hasAttribute("data-autorun") || (t.onload = function() {
...
var A, S, N = !0;
if (f || E) {
var I = e.querySelector('[data-action="run"]');
I && (I.onclick = function() {
return this.blur(), p(), !1;
});
var R = e.querySelector('[data-action="edit"]');
...
//# sourceMappingURL=qa.5654ffbfac3b486e03ca.js.map