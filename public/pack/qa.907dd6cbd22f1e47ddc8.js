...
if (E) {
p && (h = E[1].length);
var T = E.index - 1 + h, E = E[0].slice(h), b = E.length, A = T + b, S = f.slice(0, T + 1), I = f.slice(A + 1), N = [ g, 1 ];
S && N.push(S);
var v = new i(o, d ? a.tokenize(E, d) : E, m);
...
//# sourceMappingURL=qa.907dd6cbd22f1e47ddc8.js.map