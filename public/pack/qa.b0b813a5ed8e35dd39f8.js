...
T = u.exec(S), !T) continue;
var I = T.index + (p ? T[1].length : 0);
if (I >= E.length) continue;
var N = T.index + T[0].length, v = E.length + A.length;
if (b = 3, v >= N) {
...
if (T) {
p && (h = T[1].length);
var I = T.index + h, T = T[0].slice(h), N = I + T.length, y = E.slice(0, I), R = E.slice(N), w = [ f, b ];
y && w.push(y);
var O = new r(o, d ? a.tokenize(T, d) : T, m, T, g);
w.push(O), R && w.push(R), Array.prototype.splice.apply(i, w);
}
}
}
}
...
r.submit(), r.remove(), I && e.hasAttribute("data-autorun") || (t.onload = function() {
...
var f = g.classList.contains("language-javascript"), E = g.classList.contains("language-markup"), T = +e.getAttribute("data-trusted"), b = +e.getAttribute("data-no-strict");
!b && f && (m = "'use strict';\n" + m);
var A, S, I = !0;
if (f || E) {
...
//# sourceMappingURL=qa.b0b813a5ed8e35dd39f8.js.map