...
var u = l[c], d = u.inside, p = !!u.lookbehind, h = !!u.greedy, g = 0, m = u.alias;
u = u.pattern || u;
...
var T = u.exec(E), b = 1;
if (!T && h && f != r.length - 1) {
var A = r[f + 1].matchedStr || r[f + 1], S = E + A;
if (f < r.length - 2 && (S += r[f + 2].matchedStr || r[f + 2]), u.lastIndex = 0, 
T = u.exec(S), !T) continue;
var I = T.index + (p ? T[1].length : 0);
if (I >= E.length) continue;
var v = T.index + T[0].length, N = E.length + A.length;
if (b = 3, v <= N) {
...
if (T) {
p && (g = T[1].length);
var I = T.index + g, T = T[0].slice(g), v = I + T.length, y = E.slice(0, I), R = E.slice(v), w = [ f, b ];
y && w.push(y);
var L = new i(o, d ? a.tokenize(T, d) : T, m, T, h);
w.push(L), R && w.push(R), Array.prototype.splice.apply(r, w);
}
}
}
}
...
var A, S, I = !0;
if (f || E) {
var v = e.querySelector('[data-action="run"]');
v && (v.onclick = function() {
return this.blur(), p(), !1;
});
var N = e.querySelector('[data-action="edit"]');
...
//# sourceMappingURL=qa.f199b1bfe739fffa5b63.js.map