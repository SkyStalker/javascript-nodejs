...
I && L.push(I);
var R = new r(o, d ? a.tokenize(b, d) : b, g, b, m);
...
function n() {
var t;
if (v && e.hasAttribute("data-refresh") && (v.remove(), v = null), v || (v = e.querySelector(".code-result")), 
v) t = v.querySelector("iframe"); else {
if (v = document.createElement("div"), v.className = "code-result code-example__result", 
...
v.appendChild(t), e.appendChild(v);
}
if (b) {
...
}, 2e3), e.hasAttribute("data-demo-height") || s.iframe(t), y && e.hasAttribute("data-autorun") || o(v) || v.scrollIntoView(!1);
} else {
...
e.hasAttribute("data-demo-height") || s.iframe(t), o(v) || v.scrollIntoView(!1);
});
}
}
function a(e) {
...
A || (A = document.createElement("iframe"), A.className = "js-frame", A.style.width = 0, 
A.style.height = 0, A.style.border = "none", A.name = "js-global-frame", document.body.appendChild(A));
...
A.parentNode.insertBefore(n, A.nextSibling), n.submit(), n.remove();
} else if (b) {
...
var I = e.querySelector('[data-action="edit"]');
...
//# sourceMappingURL=quiz.36cd219b7a55c8abee54.js.map