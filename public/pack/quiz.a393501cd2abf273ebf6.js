...
new u.Success("Результат сохранён в профиле! <a href='/profile/" + window.currentUser.profileName + "/quiz'>Перейти в профиль</a>.", "slow");
});
}
...
}), u = e.querySelector('[type="submit"]'), c = new s({
elem: u,
size: "small",
elemClass: "button_loading"
});
c.start(), u.disabled = !0, i.addEventListener("fail", a), i.addEventListener("success", function(t) {
...
n(250);
var s = n(150), o = n(155), l = n(237), u = n(147);
a();
},
87: function(e, t) {
...
for (var n, r = document.querySelectorAll('code[class*="language-"], [class*="language-"] code, code[class*="lang-"], [class*="lang-"] code'), i = 0; n = r[i++]; ) a.highlightElement(n, e === !0, t);
},
...
var u = t.textContent, c = {
element: t,
language: s,
grammar: o,
code: u
};
if (!u || !o) return void a.hooks.run("complete", c);
...
var c = l[u], d = c.inside, p = !!c.lookbehind, m = 0, h = c.alias;
c = c.pattern || c;
...
S && w.push(S);
var y = new r(o, d ? a.tokenize(E, d) : E, h);
...
return i && (a.filename = i.src, document.addEventListener && !i.hasAttribute("data-manual") && document.addEventListener("DOMContentLoaded", a.highlightAll)), 
n.Prism;
}();
...
if (-1 == c.indexOf(r.status)) return void n("Ошибка на стороне сервера (код " + r.status + "), попытайтесь позднее.", t);
...
var r = t[a].split(":"), i = +r[0], s = r[1].split("-"), o = +s[0], l = +s[1], u = '<code class="inline-highlight">' + Array(i + 1).join("\n") + Array(o + 1).join(" ") + '<code class="mask">' + Array(l - o + 1).join(" ") + "</code></code>";
...
//# sourceMappingURL=quiz.a393501cd2abf273ebf6.js.map