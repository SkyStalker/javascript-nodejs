...
n(250);
var s = n(633), o = n(638), l = n(724), c = n(630);
a();
},
87: function(e, t) {
...
var u = l[c], d = u.inside, p = !!u.lookbehind, m = !!u.greedy, g = 0, h = u.alias;
u = u.pattern || u;
...
var b = u.exec(E), T = 1;
if (!b && m && f != i.length - 1) {
var S = i[f + 1].matchedStr || i[f + 1], A = E + S;
if (f < i.length - 2 && (A += i[f + 2].matchedStr || i[f + 2]), u.lastIndex = 0, 
...
if (b) {
p && (g = b[1].length);
var v = b.index + g, b = b[0].slice(g), y = v + b.length, I = E.slice(0, v), N = E.slice(y), L = [ f, T ];
I && L.push(I);
var R = new r(o, d ? a.tokenize(b, d) : b, h, b, m);
L.push(R), N && L.push(N), Array.prototype.splice.apply(i, L);
}
}
}
}
...
a.open(), a.write(d(h)), a.close(), "epub" == window.ebookType && setTimeout(function() {
...
i.name = "code", i.value = d(h), r.appendChild(i), t.parentNode.insertBefore(r, t.nextSibling), 
...
function c() {
if (b) {
if (e.hasAttribute("data-autorun")) return void a(h);
try {
...
function d() {
var e = h.toLowerCase(), t = e.match("<body>"), n = e.match("</body>"), a = e.match("<html>"), r = e.match("</html>"), i = e.match(/^\s*<!doctype/);
if (i) return h;
var s = h;
...
var m = e.querySelector("pre"), g = m.querySelector("code"), h = g.textContent;
Prism.highlightElement(g), l(m), r(m, e.getAttribute("data-highlight-block")), i(m, e.getAttribute("data-highlight-inline"));
...
//# sourceMappingURL=quiz.b340f36c0de5b03c3d0a.js.map