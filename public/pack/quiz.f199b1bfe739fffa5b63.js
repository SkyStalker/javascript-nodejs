...
function i(e) {
function t() {
var t = e.querySelector('[type="submit"]'), i = new s({
elem: t,
size: "small",
...
method: "POST",
url: e.action
}), a = e.querySelector('[type="submit"]'), i = new s({
elem: a,
size: "small",
elemClass: "button_loading"
});
i.start(), a.disabled = !0, n.addEventListener("loadend", t), n.addEventListener("success", function(e) {
...
function r(e) {
function t() {
for (var t = e.elements.type.value, n = e.elements.answer, a = [], i = 0; i < n.length; i++) n[i].checked && a.push(+n[i].value);
...
u.start(), c.disabled = !0, r.addEventListener("fail", a), r.addEventListener("success", function(t) {
...
n(364);
var s = n(374), o = n(379), l = n(468), c = n(371);
a();
},
87: function(e, t) {
...
for (var i, r = n.elements || document.querySelectorAll(n.selector), s = 0; i = r[s++]; ) a.highlightElement(i, e === !0, n.callback);
},
...
if (a.hooks.run("before-sanity-check", u), !u.code || !u.grammar) return void a.hooks.run("complete", u);
...
var u = l[c], d = u.inside, p = !!u.lookbehind, m = !!u.greedy, h = 0, g = u.alias;
u = u.pattern || u;
...
var b = u.exec(E), T = 1;
if (!b && m && f != r.length - 1) {
var S = r[f + 1].matchedStr || r[f + 1], A = E + S;
if (f < r.length - 2 && (A += r[f + 2].matchedStr || r[f + 2]), u.lastIndex = 0, 
b = u.exec(A), !b) continue;
var v = b.index + (p ? b[1].length : 0);
if (v >= E.length) continue;
var y = b.index + b[0].length, w = E.length + S.length;
if (T = 3, y <= w) {
...
if (b) {
p && (h = b[1].length);
var v = b.index + h, b = b[0].slice(h), y = v + b.length, I = E.slice(0, v), N = E.slice(y), L = [ f, T ];
I && L.push(I);
var R = new i(o, d ? a.tokenize(b, d) : b, g, b, m);
L.push(R), N && L.push(N), Array.prototype.splice.apply(r, L);
}
}
}
}
...
this.type = e, this.content = t, this.alias = n, this.matchedStr = a || null, this.greedy = !!i;
};
...
return r && (a.filename = r.src, document.addEventListener && !r.hasAttribute("data-manual") && ("loading" !== document.readyState ? requestAnimationFrame(a.highlightAll, 0) : document.addEventListener("DOMContentLoaded", a.highlightAll))), 
n.Prism;
}();
...
if (u.indexOf(i.status) == -1) return void n("Ошибка на стороне сервера (код " + i.status + "), попытайтесь позднее.", t);
...
function n() {
var t;
if (A && e.hasAttribute("data-refresh") && (A.remove(), A = null), A || (A = e.querySelector(".code-result")), 
A) t = A.querySelector("iframe"); else {
if (A = document.createElement("div"), A.className = "code-result code-example__result", 
...
}, 2e3), e.hasAttribute("data-demo-height") || s.iframe(t), v && e.hasAttribute("data-autorun") || o(A) || A.scrollIntoView(!1);
} else {
...
i.submit(), i.remove(), v && e.hasAttribute("data-autorun") || (t.onload = function() {
e.hasAttribute("data-demo-height") || s.iframe(t), o(A) || A.scrollIntoView(!1);
});
}
}
function a(e) {
...
} else e.hasAttribute("data-refresh") && S && (S.remove(), S = null), S ? t() : (S = document.createElement("iframe"), 
S.className = "js-frame", S.src = "https://ru.lookatcode.com/showjs", S.style.width = 0, 
S.style.height = 0, S.style.border = "none", S.onload = function() {
t();
...
Prism.highlightElement(h), l(m), i(m, e.getAttribute("data-highlight-block")), r(m, e.getAttribute("data-highlight-inline"));
...
//# sourceMappingURL=quiz.f199b1bfe739fffa5b63.js.map