...
var o = e(498)(), i = e(499).thumb, c = e(500).lang, a = e(501);
...
var o = e(502), i = new o("en"), c = e(500).lang, a = {};
...
function m(t, n, e) {
var r, o, i, c, a, u;
return k.test(n) ? (r = y.parse(n), 1 === r.length && "literal" === r[0].type ? r[0].text : (t._plurals_cache[e] || (t._plurals_cache[e] = new v(e)), 
...
return t && "function" == typeof Symbol && t.constructor === Symbol ? "symbol" : typeof t;
}, y = e(504), b = e(505), w = Array.isArray || function(t) {
return "[object Array]" === r(t);
}, F = Array.prototype.forEach, x = /%[sdj%]/g, _ = "en", E = "#@$";
...
i === F && (i = O), i !== F) {
if (c = [], a = l(), a !== F) for (;a !== F; ) c.push(a), a = l(); else c = E;
c !== F ? (gt = n, e = J(r, c), n = e) : (mt = n, n = E);
...
0 === xt && o(ct)), r !== F) {
if (i = [], c = h(), c !== F) for (;c !== F; ) i.push(c), c = h(); else i = E;
i !== F ? (gt = n, e = at(), n = e) : (mt = n, n = E);
} else mt = n, n = E; else mt = n, n = E;
return n === F && (n = d()), n;
}
function d() {
...
e = E), e !== F) for (;e !== F; ) n.push(e), e = mt, r = mt, xt++, o = a(), o === F && (o = p()), 
...
//# sourceMappingURL=screencast.095c9014a0ff31888218.js.map