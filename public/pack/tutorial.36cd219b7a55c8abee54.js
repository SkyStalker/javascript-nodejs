...
var delegate = __webpack_require__(631), prism = __webpack_require__(724), xhr = __webpack_require__(638), TutorialMapModal = __webpack_require__(762), TutorialMap = __webpack_require__(763), newsletter = __webpack_require__(650);
...
var b = u.exec(E), v = 1;
if (!b && h && f != r.length - 1) {
var y = r[f + 1].matchedStr || r[f + 1], T = E + y;
if (f < r.length - 2 && (T += r[f + 2].matchedStr || r[f + 2]), u.lastIndex = 0, 
b = u.exec(T), !b) continue;
var w = b.index + (p ? b[1].length : 0);
if (w >= E.length) continue;
var S = b.index + b[0].length, A = E.length + y.length;
if (v = 3, A >= S) {
...
if (b) {
p && (m = b[1].length);
var w = b.index + m, b = b[0].slice(m), S = w + b.length, k = E.slice(0, w), L = E.slice(S), C = [ f, v ];
k && C.push(k);
var I = new i(o, d ? a.tokenize(b, d) : b, g, b, h);
C.push(I), L && C.push(L), Array.prototype.splice.apply(r, C);
}
}
}
}
...
i.submit(), i.remove(), S && e.hasAttribute("data-autorun") || (t.onload = function() {
...
T || (T = document.createElement("iframe"), T.className = "js-frame", T.style.width = 0, 
T.style.height = 0, T.style.border = "none", T.name = "js-global-frame", document.body.appendChild(T));
...
i.name = "code", i.value = d("<script>\n" + g + "\n</script>"), n.appendChild(i), 
T.parentNode.insertBefore(n, T.nextSibling), n.submit(), n.remove();
} else if (b) {
...
function d(e) {
var t = e.toLowerCase(), n = t.match("<body>"), a = t.match("</body>"), i = t.match("<html>"), r = t.match("</html>"), s = t.match(/^\s*<!doctype/);
if (s) return e;
var o = e;
...
var i = n(638), r = n(631), s = n(636), o = n(633), l = n(763), c = n(668);
...
//# sourceMappingURL=tutorial.36cd219b7a55c8abee54.js.map