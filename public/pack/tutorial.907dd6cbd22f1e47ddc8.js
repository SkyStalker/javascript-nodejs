...
if (E) {
p && (h = E[1].length);
var b = E.index - 1 + h, E = E[0].slice(h), v = E.length, T = b + v, w = f.slice(0, b + 1), y = f.slice(T + 1), S = [ g, 1 ];
w && S.push(w);
var A = new i(o, d ? a.tokenize(E, d) : E, m);
...
//# sourceMappingURL=tutorial.907dd6cbd22f1e47ddc8.js.map