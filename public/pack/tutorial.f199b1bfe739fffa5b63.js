...
var delegate = __webpack_require__(372), prism = __webpack_require__(468), xhr = __webpack_require__(379), TutorialMapModal = __webpack_require__(508), TutorialMap = __webpack_require__(509), newsletter = __webpack_require__(391);
...
var u = l[c], d = u.inside, p = !!u.lookbehind, h = !!u.greedy, m = 0, g = u.alias;
u = u.pattern || u;
...
var b = u.exec(E), v = 1;
if (!b && h && f != r.length - 1) {
var T = r[f + 1].matchedStr || r[f + 1], y = E + T;
if (f < r.length - 2 && (y += r[f + 2].matchedStr || r[f + 2]), u.lastIndex = 0, 
b = u.exec(y), !b) continue;
var w = b.index + (p ? b[1].length : 0);
if (w >= E.length) continue;
var S = b.index + b[0].length, A = E.length + T.length;
if (v = 3, S <= A) {
...
if (b) {
p && (m = b[1].length);
var w = b.index + m, b = b[0].slice(m), S = w + b.length, L = E.slice(0, w), k = E.slice(S), C = [ f, v ];
L && C.push(L);
var I = new i(o, d ? a.tokenize(b, d) : b, g, b, h);
C.push(I), k && C.push(k), Array.prototype.splice.apply(r, C);
}
}
}
}
...
}, 2e3), e.hasAttribute("data-demo-height") || s.iframe(t), w && e.hasAttribute("data-autorun") || o(y) || y.scrollIntoView(!1);
} else {
...
e.hasAttribute("data-demo-height") || s.iframe(t), o(y) || y.scrollIntoView(!1);
});
}
}
function a(e) {
...
} else e.hasAttribute("data-refresh") && T && (T.remove(), T = null), T ? t() : (T = document.createElement("iframe"), 
T.className = "js-frame", T.src = "https://ru.lookatcode.com/showjs", T.style.width = 0, 
T.style.height = 0, T.style.border = "none", T.onload = function() {
t();
...
var f = h.classList.contains("language-javascript"), E = h.classList.contains("language-markup"), b = +e.getAttribute("data-trusted"), v = +e.getAttribute("data-no-strict");
!v && f && (g = "'use strict';\n" + g);
var T, y, w = !0;
if (f || E) {
...
var i = n(379), r = n(372), s = n(377), o = n(374), l = n(509), c = n(410);
...
//# sourceMappingURL=tutorial.f199b1bfe739fffa5b63.js.map